				...
				<form action="catalog.html" class="catalog-category">
					...
					<div class="catalog-category-wrapper catalog-category-size">
						...
						<div class="catalog-category-size-options">
							<label for="catalog-category-size-item1"><input type="checkbox" id="catalog-category-size-item1"
									class="catalog-category-size-options-item">XS</label>
							<label for="catalog-category-size-item2"><input type="checkbox" id="catalog-category-size-item2"
									class="catalog-category-size-options-item">S</label>
							<label for="catalog-category-size-item3"><input type="checkbox" id="catalog-category-size-item3"
									class="catalog-category-size-options-item">M</label>
							<label for="catalog-category-size-item4"><input type="checkbox" id="catalog-category-size-item4"
					...
					<div class="catalog-category-wrapper catalog-category-price">
						...
						<div class="catalog-category-price-options">
							<label for="catalog-category-price-item1"><input type="checkbox" id="catalog-category-price-item1"
									class="catalog-category-price-options-item">Диапазон 1</label>
							<label for="catalog-category-price-item2"><input type="checkbox" id="catalog-category-price-item2"
									class="catalog-category-price-options-item">Диапазон 2</label>
							<label for="catalog-category-price-item3"><input type="checkbox" id="catalog-category-price-item3"
									class="catalog-category-price-options-item">Диапазон 3</label>
							<label for="catalog-category-price-item4"><input type="checkbox" id="catalog-category-price-item4"
									class="catalog-category-price-options-item">Диапазон 4</label>
							<label for="catalog-category-price-item5"><input type="checkbox" id="catalog-category-price-item5"
									class="catalog-category-price-options-item">Диапазон 5</label>
						</div>
					</div>
				</form>
